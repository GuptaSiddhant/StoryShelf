/** Canonical Postgres DDL for all StoryShelf tables and indexes. */
export const DDL = `
CREATE TABLE IF NOT EXISTS projects (
  ...
  pixel_threshold DOUBLE PRECISION NOT NULL DEFAULT 0.1,
  max_diff_ratio DOUBLE PRECISION NOT NULL DEFAULT 0.01,
