...
// Keep each package's `deno.json` version in sync with its package.json version.
...
// 5.5 Sync deno.json versions to the bumped package version (tsdown regenerates on build too).
