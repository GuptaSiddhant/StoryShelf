...
Packages that implement `GitHostProvider` (e.g. `@storyshelf/git-github` `githubAdapter`) are wired in alongside the router — see [the git-github package](../git-github/).
